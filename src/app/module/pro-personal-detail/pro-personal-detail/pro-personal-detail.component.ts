...
@Component({
  selector: 'app-pro-personal-detail',
  templateUrl: './pro-personal-detail.component.html',
  styleUrls: ['./pro-personal-detail.component.scss']
})
export class ProPersonalDetailComponent {

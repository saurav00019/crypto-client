...
export class ProfileComponent {
  ...
  constructor(private modalService: NgbModal,private formBuilder : FormBuilder, 
   ...
   private http: HttpClient,private toastrService:ToastrService){
    this.sharedData.setTabValue.subscribe((res)=>{
      this.setTab = res
      console.log("SetTABbbbb", res)
          })
  ...
  setTab: any ="tab1";
  nvatabc (val:any, tab: any){
    this.setTab = tab
    console.log("this.setTab ",this.setTab );
   
        this.sharedData.setProfileTab(tab)
